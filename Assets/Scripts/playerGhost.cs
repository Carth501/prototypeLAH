...
public class playerGhost : Singleton<playerGhost>
{
    ...
    public delegate void possessionChangeDelegate(actor possessee);
    ...
    [SerializeField]
    private ActionActivationDisplay targetActionActivationDisplay;
    [SerializeField]
    ...
    public void setNewPossesson()
    {
        ...
        {
            activeCharacter.getPersonality().setPlayerControlled(false);
            activeCharacter.targetChangeEvent -= targetActionActivationDisplay.setActor;
        }
        activeCharacter = characters[possessingIndex];
        possessionChangeEvent(activeCharacter);
        activeCharacter.getPersonality().setPlayerControlled(true);
        pcActionActivationDisplay.setActor(activeCharacter);
        activeCharacter.targetChangeEvent += targetActionActivationDisplay.setActor;
    }
}
